...
import (
	...
	petproject "gopath/src/pet-project/pkg/client/informers_generated/externalversions/petproject"
	reflect "reflect"
	sync "sync"
	time "time"
...
type SharedInformerFactory interface {
	...
	Petproject() petproject.Interface
}

func (f *sharedInformerFactory) Petproject() petproject.Interface {
	return petproject.New(f, f.namespace, f.tweakListOptions)
}
