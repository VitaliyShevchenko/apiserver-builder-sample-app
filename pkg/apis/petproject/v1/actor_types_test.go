...
import (
	...
	. "gopath/src/pet-project/pkg/apis/petproject/v1"
	. "gopath/src/pet-project/pkg/client/clientset_generated/clientset/typed/petproject/v1"
)

var _ = Describe("Actor", func() {
	var instance Actor
	var expected Actor
	var client ActorInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.PetprojectV1().Actors("actor-test-valid")
